...
ggsave("Figure6.pdf", fig4, height = 7.5, width = 7.5, units = "in")
ggsave("Figure6.png", fig4, height = 7.5, width = 7.5, units = "in")
ggsave("Figure6.eps", fig4, height = 7.5, width = 7.5, units = "in", device = cairo_ps)
