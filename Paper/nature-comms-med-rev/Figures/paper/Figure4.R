...
ggsave("Figure4.pdf", fig2, width = 5.2, height = 3.8, units = "in")
ggsave("Figure4.png", fig2, width = 5.2, height = 3.8, units = "in")
ggsave("Figure4.eps", fig2, width = 5.2, height = 2.6, units = "in", device = cairo_ps)
