...
results_age1 <- read_csv(paste0('~/Dropbox/zaf-circumcision-rates/Output/Analysis/', version, '/Results_Age_Probability.csv'))
results_age2 <- read_csv(paste0('~/Dropbox/zaf-circumcision-rates/Output/Analysis/', version, '/Results_Age_Incidence.csv'))
results_age3 <- read_csv(paste0('~/Dropbox/zaf-circumcision-rates/Output/Analysis/', version, '/Results_Age_Prevalence.csv'))
...
ggsave("Figure8.pdf", fig6, height = 4.5, width = 4.5, units = "in")
ggsave("Figure8.png", fig6, height = 4.5, width = 4.5, units = "in")
ggsave("Figure8.eps", fig6, height = 4.5, width = 4.5, units = "in", device = cairo_ps)
