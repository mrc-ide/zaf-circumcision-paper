...
ggsave("Figure3.pdf", fig1, width = 5.2, height = 2.6, units = "in")
ggsave("Figure3.png", fig1, width = 5.2, height = 2.6, units = "in")
ggsave("Figure3.eps", fig1, width = 5.2, height = 2.6, units = "in", device = cairo_ps)
