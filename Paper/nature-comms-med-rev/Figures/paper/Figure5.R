...
ggsave("Figure5.pdf", fig3, width = 5.2, height = 6.8, units = "in")
ggsave("Figure5.png", fig3, width = 5.2, height = 6.8, units = "in")
ggsave("Figure5.eps", fig3, width = 5.2, height = 6.8, units = "in", device = cairo_ps)
