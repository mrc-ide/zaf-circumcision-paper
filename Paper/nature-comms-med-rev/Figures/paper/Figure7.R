...
ggsave("Figure7.pdf", fig5, height = 7.5, width = 7.5, units = "in")
ggsave("Figure7.png", fig5, height = 7.5, width = 7.5, units = "in")
ggsave("Figure7.eps", fig5, height = 7.5, width = 7.5, units = "in", device = cairo_ps)
