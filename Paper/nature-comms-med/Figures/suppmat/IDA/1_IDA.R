...
dat_program <- read.csv('Data/Processed/zaf_circumcision_program_data.csv') 
...
# Creating plot 
pdf('Documents/Survival/Figures/suppmat/IDA/NumMMC_PEPFAR_District.pdf', width = 24, height = 21)
ggplot(subset(tmp, area_level == 2 & year < 2020),
       aes(x = year, 
           y = mmc_performed/1000)) + 
  geom_bar(stat = 'identity',
           fill = wesanderson::wes_palette("Zissou1", 5)[1]) + 
  labs(x = 'Year',
...
pdf('Documents/Survival/Figures/suppmat/IDA/NumMMC_DMPPT2_District.pdf', width = 24, height = 21)
ggplot(subset(tmp, area_level == 2 & year < 2020),
       aes(x = year, 
           y = mmc_performed/1000)) + 
  geom_bar(stat = 'identity',
...
pdf('Documents/Survival/Figures/suppmat/IDA/NumMMC_DHIS_District.pdf', width = 24, height = 21)
ggplot(subset(tmp, area_level == 2),
       aes(x = year, 
           y = mmc_performed/1000)) + 
  geom_bar(stat = 'identity',
           fill = wesanderson::wes_palette("Zissou1", 3)[1]) + 
  labs(x = 'Year',
       y = 'VMMCs performed (in 1000s)',
       fill = '') + 
...
pdf('Documents/Survival/Figures/suppmat/IDA/NumMMC_Model_District.pdf', width = 25, height = 21)
ggplot(dat_program,
       aes(x = year,
           y = mmc_performed/1000,
           group = type,
  ...
  scale_fill_manual(values = wesanderson::wes_palette("Zissou1", 4)) +
  labs(x = 'Year',
       y = 'VMMCs performed (in 1000s)',
       fill = ''
