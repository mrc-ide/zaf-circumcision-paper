...
pdf('Documents/Survival/Figures/suppmat/VMMCs/MMCsComparison_District.pdf', width = 24, height = 21)
ggplot(subset(tmp, year %in% 2010:2019 & area_level == 2),
       aes(x = year,
  ...
  labs(x = 'Year',
       ...
       fill = '') +
  theme_minimal() +
  facet_geo(~ area_id, grid = zaf_district_grid, label = "name_district",
            scale = 'free_y') +
