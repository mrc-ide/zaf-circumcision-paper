...
###################################################
for (i in c('MC coverage', 'MMC coverage', 'TMC coverage')){
  # Subsetting
  ...
  # Outputting plot
  pdf(paste('Documents/Survival/Figures/suppmat/Coverage/', gsub(' ', '', i), '_SingleAge_Province.pdf', sep = ''), width = 12, height = 9)
  print(p1)
  dev.off()
}
...
for (i in c('MC coverage', 'MMC coverage', 'TMC coverage')){
  ...
  p1 <- ggplot(tmp1, 
    ...
    theme(axis.text = element_text(size = 14),
          ...
          legend.position = 'bottom')
  # Outputting plot
  pdf(paste('Documents/Survival/Figures/suppmat/Coverage/', gsub(' ', '', i), '_SingleAge_District.pdf', sep = ''), width = 24, height = 21 )
  print(p1)
  dev.off()
}
